...
namespace HRMSDevelopment.Model.Migrations
{
    ...
    [Migration("20240213165922_MigrationForBonusManagementModule2")]
    partial class MigrationForBonusManagementModule2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HRMSDevelopment.Model.DBEntity.BonusDistribution", b =>
                {
                    ...
                    b.Property<int>("BonusEligibilityId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("BonusEligibilityId");

                    b.ToTable("BonusDistributions");
                });

            modelBuilder.Entity("HRMSDevelopment.Model.DBEntity.BonusEligibility", b =>
                {
                    b.Property<int>("BonusEligibilityId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("BonusEligibilityId"));
                    ...
                    b.HasKey("BonusEligibilityId");

                    b.HasIndex("BonusCriteriaId");

                    b.HasIndex("EmployeeId");

                    b.ToTable("BonusEligibilities");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "c209d745-dcf7-415c-a449-0d759e33f1b2",
                            ConcurrencyStamp = "1",
                            Name = "Admin",
                        ...
                        new
                        {
                            Id = "91a57178-9f2b-4ae3-889f-0b0d0f1c16b2",
                            ConcurrencyStamp = "2",
                            Name = "HR",
                            NormalizedName = "HR"
                        },
                        new
                        {
                            Id = "e3af3570-f64a-4592-878b-69e00484f253",
                            ConcurrencyStamp = "3",
                            Name = "Employee",
            ...
            modelBuilder.Entity("HRMSDevelopment.Model.DBEntity.BonusDistribution", b =>
                {
                    b.HasOne("HRMSDevelopment.Model.DBEntity.BonusEligibility", "BonusEligibility")
                        .WithMany("BonusDistributions")
                        .HasForeignKey("BonusEligibilityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BonusEligibility");
                });

            modelBuilder.Entity("HRMSDevelopment.Model.DBEntity.BonusEligibility", b =>
                {
                    b.HasOne("HRMSDevelopment.Model.DBEntity.BonusCriteria", "BonusCriteria")
                        .WithMany("BonusEligibilities")
            ...
            modelBuilder.Entity("HRMSDevelopment.Model.DBEntity.BonusCriteria", b =>
                {
                    b.Navigation("BonusEligibilities");
                });
